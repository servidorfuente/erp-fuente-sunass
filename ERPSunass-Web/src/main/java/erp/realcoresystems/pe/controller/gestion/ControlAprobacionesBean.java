...
@ManagedBean(name = "controlAprobacionesBean")
@ViewScoped
public class ControlAprobacionesBean extends AbstractGenericBean implements InterfaceGenericBean {
    ...
    public boolean esValidoFormulario( SsControlperiodo objSave) {
        ...
        if(!UtilesCommons.noEsVacio(ssControlperiodoRegistro.getProyectoid())){
            FacesUtil.adicionarMensajeWarning("Seleccione proyecto.");
            validoFormulario = false;
        }
        if(!UtilesCommons.noEsVacio(ssControlperiodoRegistro.getAnno())){
            FacesUtil.adicionarMensajeWarning("Ingrese año.");
            validoFormulario = false;
        }
        if(!esValidoxFormulario(ssControlperiodoRegistro)){
            validoFormulario = false;
